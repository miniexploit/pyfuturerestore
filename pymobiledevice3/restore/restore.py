...
class Restore(BaseRestore):
    def __init__(self, ipsw: BytesIO, device: Device, tss=None, sepfwdata=None, sepbuildmanifest=None, bbfwdata=None, basebandbuildmanifest=None, behavior: Behavior = Behavior.Update, ignore_fdr=False):
