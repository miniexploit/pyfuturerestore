...
class BaseRestore:
    def __init__(self, ipsw: BytesIO, device: Device, tss=None, sepfwdata=None, sepbuildmanifest=None, bbfwdata=None, basebandbuildmanifest=None, behavior: Behavior = Behavior.Update, logger=None):
        ...
        self.sepfwdata = sepfwdata
        self.bbfwdata = bbfwdata
        ...
        if sepbuildmanifest:
            self.ipsw.load_custom_manifest(sepbuildmanifest)
            self.sep_build_identity = self.ipsw._build_manifest.get_build_identity(self.device.hardware_model,
                                                                              ...
                                                                              variant=variant)
        if basebandbuildmanifest:
            self.ipsw.load_custom_manifest(basebandbuildmanifest)
